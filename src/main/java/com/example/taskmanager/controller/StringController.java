...
public class StringController {
    ...
    @GetMapping("/count-consonants")
    public ResponseEntity<Long> countConsonants(@RequestParam String input) {
        return ResponseEntity.ok(stringService.countConsonants(input));
    }
}
